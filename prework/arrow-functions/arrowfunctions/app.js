...
const oldObject = (array) => ({ firstValue: array[0], secondValue: array[1], thirdValue: array[2]});
...
// Arrow functions aren't designed to execute in different scopes. Arrow functions recognize "this" based upon the scope that arrow function is defined in. Sometimes it will recognize "this" as the Window scope.
